...
public class DoomWeaponItems {
	...
	public static class RegistryEvents {
		...
		public static void registerItems(final RegistryEvent.Register<Item> event) {
			// ITEMS
			event.getRegistry().register(DOOM_INGOT = new Item(new Item.Properties().group(DoomTab.DoomItemGroup))
					.setRegistryName(DoomWeaponMod.MODID, "doom_ingot"));
			// WEAPON
			event.getRegistry().registerAll(CRUCIBLE = new SwordCrucibleItem("doomcrucible_open"),
					new Item(new Item.Properties().group(DoomTab.DoomItemGroup)).setRegistryName(DoomWeaponMod.MODID,
							"doomcrucible_closed"),
			...
			event.getRegistry().registerAll(
					...
					new DoomArmor(DoomArmorMaterial.ASTRO_DOOM_ARMOR, EquipmentSlotType.HEAD, "astro_doom_helmet"),
					new DoomArmor(DoomArmorMaterial.ASTRO_DOOM_ARMOR, EquipmentSlotType.CHEST, "astro_doom_chestplate"),
					new DoomArmor(DoomArmorMaterial.ASTRO_DOOM_ARMOR, EquipmentSlotType.LEGS, "astro_doom_leggings"),
					new DoomArmor(DoomArmorMaterial.ASTRO_DOOM_ARMOR, EquipmentSlotType.FEET, "astro_doom_boots"),
					new DoomArmor(DoomArmorMaterial.CRIMSON_DOOM_ARMOR, EquipmentSlotType.HEAD, "crimson_doom_helmet"),
					...
					new DoomArmor(DoomArmorMaterial.CRIMSON_DOOM_ARMOR, EquipmentSlotType.FEET, "crimson_doom_boots"),
					...
					new DoomArmor(DoomArmorMaterial.MIDNIGHT_DOOM_ARMOR, EquipmentSlotType.FEET, "midnight_doom_boots"),
					...
					new DoomArmor(DoomArmorMaterial.DEMONIC_DOOM_ARMOR, EquipmentSlotType.HEAD, "demonic_doom_helmet"),
					...
					new DoomArmor(DoomArmorMaterial.DEMONIC_DOOM_ARMOR, EquipmentSlotType.FEET, "demonic_doom_boots"),
					...
					new DoomArmor(DoomArmorMaterial.SENTINEL_DOOM_ARMOR, EquipmentSlotType.FEET, "sentinel_doom_boots"),
					new DoomArmor(DoomArmorMaterial.EMBER_DOOM_ARMOR, EquipmentSlotType.HEAD, "ember_doom_helmet"),
					new DoomArmor(DoomArmorMaterial.EMBER_DOOM_ARMOR, EquipmentSlotType.CHEST, "ember_doom_chestplate"),
					new DoomArmor(DoomArmorMaterial.EMBER_DOOM_ARMOR, EquipmentSlotType.LEGS, "ember_doom_leggings"),
					new DoomArmor(DoomArmorMaterial.EMBER_DOOM_ARMOR, EquipmentSlotType.FEET, "ember_doom_boots"),
					new DoomArmor(DoomArmorMaterial.ZOMBIE_DOOM_ARMOR, EquipmentSlotType.HEAD, "zombie_doom_helmet"),
					new DoomArmor(DoomArmorMaterial.ZOMBIE_DOOM_ARMOR, EquipmentSlotType.CHEST,
							"zombie_doom_chestplate"),
					new DoomArmor(DoomArmorMaterial.ZOMBIE_DOOM_ARMOR, EquipmentSlotType.LEGS, "zombie_doom_leggings"),
					new DoomArmor(DoomArmorMaterial.ZOMBIE_DOOM_ARMOR, EquipmentSlotType.FEET, "zombie_doom_boots"),
					new DoomArmor(DoomArmorMaterial.DOOMICORN_DOOM_ARMOR, EquipmentSlotType.HEAD,
							"doomicorn_doom_helmet"),
					new DoomArmor(DoomArmorMaterial.DOOMICORN_DOOM_ARMOR, EquipmentSlotType.CHEST,
