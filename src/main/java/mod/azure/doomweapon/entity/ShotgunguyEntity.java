...
import mod.azure.doomweapon.entity.ai.goal.RangedShotgunAttackGoal;
...
public class ShotgunguyEntity extends MonsterEntity implements IRangedAttackMob {
	...
	public void attackEntityWithRangedAttack(LivingEntity target, float distanceFactor) {
		...
		this.playSound(ModSoundEvents.SHOTGUN_SHOOT.get(), 1.0F, 1.0F / (this.getRNG().nextFloat() * 0.4F + 0.8F));
