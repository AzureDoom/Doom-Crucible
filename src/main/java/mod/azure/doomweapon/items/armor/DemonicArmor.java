...
public class DemonicArmor extends ItemArmor {

	public DemonicArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String name) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add("\u00A7o" + "\u00A7e" + "Built from the bodies of the fallen Nether spawn around you.");
