...
public class PraetorArmor extends ItemArmor {

	public PraetorArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String name) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
		tooltip.add("\u00A7o" + "\u00A7e" + "Crafted by the Wretch for the Doom Slayers Conquest of the Nether.");
