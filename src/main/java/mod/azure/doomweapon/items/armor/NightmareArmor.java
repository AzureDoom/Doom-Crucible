...
public class NightmareArmor extends ItemArmor {

	public NightmareArmor(ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn, String name) {
