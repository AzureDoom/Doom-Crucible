...
//    LeftArmPunch = new ModelRenderer(this, "LeftArm").setTextureOffset(32, 112);
//    LeftArmPunch.setRotationPoint(5.0F, 2.0F, 0.0F);
//    LeftArmPunch.addBox(-1.0F, -2.0F, -2.0F, 4, 12, 4, modelSize);
//    RightArmPunch = new ModelRenderer(this, "RightArm").setTextureOffset(40, 80);
//    RightArmPunch.setRotationPoint(-5.0F, 2.0F, 0.0F);
//    RightArmPunch.addBox(-3.0F, -2.0F, -2.0F, 4, 12, 4, modelSize);
...
//{
//	
//	this.setRotationAngles(entity, f, f1, f2, f3, f4);
//		this.Head.render(f5);
//    
// }
...
//    this.HeadWear.rotateAngleX = headPitch * ((float)Math.PI / 180F);
    ...
    if (flag) {
       ...
       if (flag1) {
          ...
          this.bipedHead.rotateAngleX = this.rotLerpRad(this.Head.rotateAngleX, (-(float)Math.PI / 4F), this.swimAnimation);
          this.bipedHeadwear.rotateAngleX = this.rotLerpRad(this.Head.rotateAngleX, (-(float)Math.PI / 4F), this.swimAnimation);
       } else {
          this.Head.rotateAngleX = this.rotLerpRad(this.Head.rotateAngleX, headPitch * ((float)Math.PI / 180F), this.swimAnimation);
          this.bipedHead.rotateAngleX = this.rotLerpRad(this.Head.rotateAngleX, headPitch * ((float)Math.PI / 180F), this.swimAnimation);
          this.bipedHeadwear.rotateAngleX = this.rotLerpRad(this.Head.rotateAngleX, headPitch * ((float)Math.PI / 180F), this.swimAnimation);
       }
    } else {
       this.Head.rotateAngleX = headPitch * ((float)Math.PI / 180F);
    }
...
//       this.bipedHead.rotationPointY = 0.0F;
    ...
    if (this.swimAnimation > 0.0F) {
       ...
       if (f7 < 14.0F) {
          ...
          this.LeftArm.rotateAngleZ = this.rotLerpRad(this.LeftArm.rotateAngleZ, (float)Math.PI + 1.8707964F * this.getArmAngleSq(f7) / this.getArmAngleSq(14.0F), this.swimAnimation);
          this.RightArm.rotateAngleZ = MathHelper.lerp(f8, this.RightArm.rotateAngleZ, (float)Math.PI - 1.8707964F * this.getArmAngleSq(f7) / this.getArmAngleSq(14.0F));
