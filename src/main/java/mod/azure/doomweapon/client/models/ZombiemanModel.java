...
public class ZombiemanModel<T extends ZombiemanEntity> extends SegmentedModel<T> implements IHasArm, IHasHead {
	...
	public ZombiemanModel(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
		...
		ModelRenderer modelrenderer1 = (new ModelRenderer(this, 44, 22)).setTextureSize(textureWidthIn,
				textureHeightIn);
	...
	public Iterable<ModelRenderer> getParts() {
		return ImmutableList.of(this.head, this.body, this.field_217143_g, this.field_217144_h, this.arms,
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		if (this.isSitting) {
			...
			this.field_217144_h.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F
