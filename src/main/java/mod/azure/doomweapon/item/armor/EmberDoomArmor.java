...
public class EmberDoomArmor extends ArmorItem {

	public EmberDoomArmor(IArmorMaterial materialIn, EquipmentSlotType slot, String name) {
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
		tooltip.add(new StringTextComponent(
				"\u00A7o" + "\u00A7e" + "Your rage burns everything."));
